...
const styles = {
  base: 'mt-1.5 w-full px-2.5 py-2.5 flex items-center justify-between text-sm rounded-lg border border-nym-green-primary outline-none transition-colors duration-500',
