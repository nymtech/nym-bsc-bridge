...
const defaultClassName =
  'mt-1.5 px-2.5 py-2.5 text-sm rounded-lg border border-nym-green-primary focus:border-nym-green-dark disabled:bg-gray-150 outline-none transition-all duration-300';
